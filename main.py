...
def give_me_all_auras_cmd(msg):
    ...
    warning_message = (
        "⚠️ [WARNING: THE POINT OF NO RETURN]\n\n"
        "This command is not just a line of code. It has the power to shatter "
        "the game balance that has been built with care over weeks and months. "
        "Think of the hundreds of players whose efforts, time, and dedication "
        "could be devalued in a single second.\n\n"
        "Are you truly ready to carry the weight of this decision? Is your "
        "temporary need more important than the integrity of this world?\n\n"
        "Y/N"
    )
